...
public class MainMenu {
	...
	protected void createContents() {
		...
		shell.setBackgroundImage(SWTResourceManager.getImage(MainMenu.class, "/images/backgrounds.jpeg"));
		...
		logo.setBackgroundImage(SWTResourceManager.getImage(MainMenu.class, "/images/Review-Checker.png"));
		...
		result.setBounds(320, 479, 362, 27);
		...
		author.setBounds(585, 527, 250, 15);
		author.setText("By: Justin Chilleo, Phil Custer, and Aj Vescovi");
